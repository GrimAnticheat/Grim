...
public class BlockPlaceCheck extends Check implements RotationCheck {
    ...
    protected SimpleCollisionBox getCombinedBox(final BlockPlace place) {
        ...
        CollisionBox placedOn = HitboxData.getBlockHitbox(player, place.getMaterial(), player.getClientVersion(), player.getCompensatedWorld().getWrappedBlockStateAt(clicked), clicked.getX(), clicked.getY(), clicked.getZ());
