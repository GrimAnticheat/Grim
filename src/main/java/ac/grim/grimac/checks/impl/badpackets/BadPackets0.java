...
@CheckData(name = "BadPackets0", experimental = true)
public class BadPackets0 extends Check implements PacketCheck, PostPredictionCheck {
    public BadPackets0(final GrimPlayer player) {
        super(player);
    }
