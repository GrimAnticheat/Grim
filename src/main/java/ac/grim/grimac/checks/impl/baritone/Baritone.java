...
public class Baritone extends Check implements RotationCheck {
    public Baritone(final GrimPlayer playerData) {
        super(playerData);
    }
    ...
    public void process(final RotationUpdate rotationUpdate) {
        ...
        if (rotationUpdate.getDeltaXRot() != 0 || deltaPitch <= 0 || deltaPitch >= 1 || Math.abs(to.getPitch()) == 90f) return;
