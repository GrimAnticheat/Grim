...
@CheckData(name = "AimDivisorY")
public class AimDivisorY extends Check implements RotationCheck {
    public AimDivisorY(GrimPlayer playerData) {
        super(playerData);
    }
    ...
    public void process(final RotationUpdate rotationUpdate) {
        ...
        invalidDivisorList.add(divisorY < GrimMath.MINIMUM_DIVISOR);
