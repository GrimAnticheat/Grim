...
public class ReusingWrapperBenchmarkFixed {
    ...
    public static class ThreadState {
        ...
        void useOriginal() {
            latencyUtils      = new V3LatencyUtils(player);
        ...
        void useBitRepack() {
            latencyUtils      = new V3LatencyUtils(player);
            blockChangeHandler= new V1160MultiBlockChangeBitRepackHandler();
            initLatency();
        }
    ...
    @Benchmark @Group("BitRepack")
    public void bitRepackHandler(ThreadState s, Blackhole bh) {
        s.useBitRepack();
        runWorkloadLoop(s,bh);
    }
