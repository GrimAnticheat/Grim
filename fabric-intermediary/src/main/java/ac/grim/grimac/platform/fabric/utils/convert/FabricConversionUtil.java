...
// Only the static converters below are used; the per-version ItemStack/text
// conversion is implemented in the concrete IFabricConversionUtil classes
// (e.g. Fabric1205ConversionUtil), which implement the interface directly rather
