...
import ac.grim.grimac.platform.fabric.mc1201.command.Fabric1201PlayerSelectorAdapter;
import ac.grim.grimac.platform.fabric.mc1201.entity.Fabric1201GrimEntity;
import ac.grim.grimac.platform.fabric.mc1201.player.Fabric1201PlatformPlayer;
import ac.grim.grimac.platform.fabric.mc1201.convert.Fabric1201ConversionUtil;
import net.fabricmc.fabric.api.event.lifecycle.v1.ServerLifecycleEvents;

public class GrimACFabric1201LoaderPlugin extends ac.grim.grimac.platform.fabric.GrimACFabricLoaderPlugin {

    protected final FabricPlatformServer platformServer = new Fabric1201PlatformServer();

    protected final PlatformPlayerFactory playerFactory = new FabricPlatformPlayerFactory(
            Fabric1201PlatformPlayer::new,
            Fabric1201GrimEntity::new,
            FabricPlatformInventory::new
    );
    protected final ParserDescriptorFactory parserFactory = new FabricParserDescriptorFactory(
            new FabricPlayerSelectorParser<>(Fabric1201PlayerSelectorAdapter::new)
    );
    ...
    public void onPreLaunch() {
        ...
        FabricConversionUtil.setConverters(
                ...
                Fabric1201ConversionUtil::toNativeText
        );
    }
    ...
    @Override
    public FabricPlatformServer getPlatformServer() {
