package ac.grim.grimac.platform.fabric.mc1201.entity;
...
public class Fabric1201GrimEntity extends FabricGrimEntity {

    public Fabric1201GrimEntity(Entity entity) {
        super(entity);
    }
