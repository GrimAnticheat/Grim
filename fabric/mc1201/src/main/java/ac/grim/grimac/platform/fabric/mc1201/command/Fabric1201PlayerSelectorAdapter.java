package ac.grim.grimac.platform.fabric.mc1201.command;
...
public class Fabric1201PlayerSelectorAdapter implements PlayerSelector {
    protected final org.incendo.cloud.minecraft.modded.data.SinglePlayerSelector fabricSelector;

    public Fabric1201PlayerSelectorAdapter(org.incendo.cloud.minecraft.modded.data.SinglePlayerSelector fabricSelector) {
