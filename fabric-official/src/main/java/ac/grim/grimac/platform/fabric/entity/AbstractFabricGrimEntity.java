...
public abstract class AbstractFabricGrimEntity implements GrimEntity {
    ...
    public PlatformWorld getWorld() {
        // entity.level is Level; LevelMixin injects PlatformWorld via the loom:injected_interfaces
        // entry in fabric.mod.json. Cast through Object to satisfy javac on the static type.
        return (PlatformWorld) (Object) this.entity.level;
    }
