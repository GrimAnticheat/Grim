# GrimAC
THIS IS A FORK OF https://github.com/GrimAnticheat/Grim
...
1. git clone https://github.com/Grim-Reloaded/Grim (or click green code button, download code, then unzip)
2. cd Grim
3. gradlew build
