...
public final class BaritoneVerbose {
    private BaritoneVerbose() {
    }

    public static void register(@NotNull VerboseRegistry registry, @NotNull CheckRegistry checks) {
        registerStructured(registry, checks, Baritone.class, Baritone.V,
                formatter(Baritone.V, (in, ctx, out) -> out.text("Divisor ").num(in.rf64())));
    }
